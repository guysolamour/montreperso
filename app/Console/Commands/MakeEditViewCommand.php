...
class MakeEditViewCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'MakeEditView {table_name} {--G|generate} {--D|delete}';
     ...
     * @var string
     */
    protected $description = 'Generate the edit view of the database table name';
    ...
    public function handle()
    {
        ...
        // Création (composition) du nom du fichier ( edit.blade.php) à créer 
        $path = $this->getSourceFilePath('edit');
    ...
    */ 
    ...
    { 
        return [ 
            ...
            '{{editViewContent}}' => $this->editViewContent($this->argument('table_name')),
    ...
    {
        return base_path('resources\\views') .'\\' .$this->getClassName($this->argument('table_name')) .'\\'. $filename.'.blade.php';
    }
     ...
     * for the laravel view edit
     *
     * @param  string  $table_name
     * @return string $editViewContent
     */
    protected function editViewContent($table_name)
    {
        ...
        /////////NOUVEAUX CODES
        $tables_parents = $this->getReferenced_Table_Names($this->argument('table_name'));
        // dd()
        foreach($tables_parents as $tableName){
            ...
            $editViewCode .= "<div class=\"col-xs-12 col-sm-12 col-md-12\">
        ...
        foreach($filtered as $item){
            ...
            if(!in_array($item->Field, $fk_colomns)){
                ...
                <div class=\"form-group\">
                    ...
                    <input type=\"text\" name=\"$item->Field\" value=\"{{ $$modelVariable -> $item->Field }}\" class=\"form-control\" placeholder=\"$item->Field\" required>
                </div>
            </div>".PHP_EOL;
                }
        }
