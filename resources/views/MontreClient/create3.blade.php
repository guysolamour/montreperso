            ...
            Alpine.data('buildwatch', () => ({
                data: {
                    ...
                    form: {
                        ...
                        inscription: {
                            nom: 'kra',
                            prenoms: 'bahoken marie de couille',
                            contact: '789651462',
                            email: 'test@asorf.com',
                            password: '12345678',
                ...
                changerPrevisualisationArrierePlan(chemin){
                    this.$refs['previsualisation'].style.backgroundImage="url("+ chemin  +")"
                },
                ...
                augmenterTailleTexte(){
                    ...
                    this.$refs['textContenu'].style.fontSize = taille + 'px'
                },
                reduireTailleTexte(){
                    const taille = parseInt(this.$refs['textContenu'].style.fontSize.slice(0, -2), 10) - 2
                    this.$refs['textContenu'].style.fontSize = taille + 'px'
                ...
                changerPositionTextVersHaut(){
                    ...
                    this.$refs['textContenu'].style['top'] = taille + '%'
                },
                ...
                changerPositionTextVersGauche(){
                    ...
                    this.$refs['textContenu'].style['left'] = taille + '%'
                },
...
@section('content')
    <div class="container" style="margin-top: 90px;"  x-data="buildwatch">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center mb-3">Personnalisation de montre5</h2>
                <textarea class="form-control" x-text="JSON.stringify(data.userConnecte)"></textarea>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="ajouterTexte" method="POST" id="ajouterTexte">
                            <div class="mb-3">
                                <label>Texte</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" form="ajouterTexte" class="btn btn-primary" data-dismiss="modal">Valider</button>
                    </div>
                </div>
            </div>
        </div>
