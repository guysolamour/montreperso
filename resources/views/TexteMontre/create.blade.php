...
<form action="{{ route('texte_montre.store') }}" method="POST" enctype="multipart/form-data" style=" max-width: 500px; padding: 5px; margin: auto;">
    @csrf
...
<div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="id_montre_client" class="form-control" placeholder="id_montre_client" required>
                </div>
            </div>
